...
setwd("C:/Users/utente/Documents/R/GitHub_Projects/Binary_Classification_with_CARET")
...
data <- as.data.frame(data %>%
                      mutate(Y=case_when((Y == 1) ~ "Positive",
                                         (Y == 0) ~ "Negative")))

table(data$Y) #Verify if your dataset is balanced or not
